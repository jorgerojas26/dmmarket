...
router.route("/best/product/:productId").get(showNoe, controller.GET_BEST_CLIENTS_PER_PRODUCT);
router.route("/average/month/:clientId").get(showNoe, controller.MONTHLY_AVERAGE);
