...
describe('PurchaseDetailModal', () => {
    it('renders nothing when show is false', () => {
        const { container } = render(<PurchaseDetailModal show={false} onClose={jest.fn()} purchase={mockPurchase} />);
        expect(container.innerHTML).toBe('');
    });

    it('renders modal with purchase info when show is true', () => {
        render(<PurchaseDetailModal show={true} onClose={jest.fn()} purchase={mockPurchase} />);
    ...
    it('renders subtotals for each product', () => {
        render(<PurchaseDetailModal show={true} onClose={jest.fn()} purchase={mockPurchaseUnique} />);
    ...
    it('shows loading spinner when purchase is null', () => {
        render(<PurchaseDetailModal show={true} onClose={jest.fn()} purchase={null} />);
    ...
    it('shows empty state when purchase has no products', () => {
        ...
        render(<PurchaseDetailModal show={true} onClose={jest.fn()} purchase={emptyPurchase} />);
